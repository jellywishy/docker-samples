...
$stream = new GuzzleHttp\Client()->get("https://jsonplaceholder.typicode.com/users/")->getBody();
...
<head>
    ...
    <title>Nginx + PHP + PostgreSQL + Composer</title>
    <style>
        ...
        #composer { background-color: rgb(150 75 0 / 25%); }
